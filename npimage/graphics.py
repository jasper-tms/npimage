...
def iround(n):
    ...
    # round to 0.0, etc." I think this convention is potentially problematic
    # for graphics applications, that is, it could break watertightness of
    # shapes that are supposed to be watertight, so I'm not using it here.
